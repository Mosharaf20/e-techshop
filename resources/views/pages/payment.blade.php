            ...
            <div class="row">
                <div class="col-lg-8"  style="border: 1px solid grey; padding: 20px;">
                    <div class="cart_container">
                    	<div class="contact_form_title text-center"><u>Cart Products</u></div>
                 ...
                 <div class="col-lg-4"  style="border: 1px solid grey; padding: 20px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                           ...
                           <div class="form-group">
                                <ul class="logos_list " >
                                            <li><input type="radio" name="payment" value="stripe"> <img src="{{ asset('public/frontend/images/logos_2.png') }}" style="width: 50px; height: 30px;"></li>
                                            <li><input type="radio" name="payment" value="paypal"> <img src="{{ asset('public/frontend/images/logos_1.png') }}" style="width: 50px; height: 30px;"></li>
                                             <li><input type="radio" name="payment" value="ideal"> <img src="{{ asset('public/frontend/images/logos_3.png') }}" style="width: 50px; height: 30px;"></li>
                                 </ul>
                            </div><br>
