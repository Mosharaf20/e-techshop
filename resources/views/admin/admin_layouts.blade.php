...
<html lang="en">
 ...
 @guest
     ...
     @else
     <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Ecommarce</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="" class="nav-link">Cancel Orders</a></li>
        </ul>
        @else
        @endif
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Subcriber</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.newslater') }}" class="nav-link">Add Subcriber</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
              ...
              <li class="nav-item"><a href="{{route('admin.database.backup')}}" class="nav-link">Database Beckup</a></li>
            </ul>
