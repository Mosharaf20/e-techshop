            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Coupon Persentage</th>
            ...
            <form method="post" action="{{ route('store.coupon') }}">
              ...
              <div class="modal-body pd-20">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Coupon Enter" name="coupon">
                </div>
